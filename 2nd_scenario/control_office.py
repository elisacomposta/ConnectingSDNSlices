...
class SimpleSwitch(app_manager.RyuApp):
    ...
    def _packet_in_handler(self, ev):
        ...
        #dump packets and avoid to save rows in switch3 when the destination is not reachable
        if dpid==3 and (msg.in_port==2 or msg.in_port==1) and dst in self.unreachable:
            return
