...
class SimpleSwitch(app_manager.RyuApp):
    ...
    unreachable=["00:00:00:00:00:03","00:00:00:00:00:04",
    ...
    def _packet_in_handler(self, ev):
        ...
        #dump packets and avoid to save rows in switch10 when the destination is not reachable
        if dpid==10 and (msg.in_port==1 or msg.in_port==4) and dst in self.unreachable:
            return
        
        if dpid in self.end_switches:  #switch with slicing(s10)
